...
#
#
# fiji_app_dir = r'C:\Users\mpinkert\Desktop\Fiji.app'
#
...
#
# ij1 = autoclass('net.imagej')
# ij1.run('Grid/Collection stitching', 'type=[Grid: row-by-row] order=[Right & Down                ] grid_size_x=3 grid_size_y=1'
#               'tile_overlap=27 first_file_index_i=0 directory=F:\\Research\\LINK\\US\\2018-08-17\\ '
#               'file_names=FirstImage3D_Overlap-27_{i}.tif output_textfile_name=TileConfiguration.txt '
...
#               'image_output=[Write to disk] output_directory=[F:\\Research\\LINK\\US\\2018-08-17\\grid output]')
...
test = ij.script().run('macro.ijm', macro_args, True).get()

# stitching = autoclass('plugin.Stitching_Grid')
#
#
# directory = r'F:\Research\LINK\US\2018-08-17'
#
# test = stitching()
# test.run('type=[Grid: row-by-row] order=[Right & Down                ] grid_size_x=3 grid_size_y=1'
#               'tile_overlap=27 first_file_index_i=0 directory=F:\\Research\\LINK\\US\\2018-08-17\\ '
#               'file_names=FirstImage3D_Overlap-27_{i}.tif output_textfile_name=TileConfiguration.txt '
#               'fusion_method=[Linear Blending] regression_threshold=0.30 max/avg_displacement_threshold=2.50 '
#               'absolute_displacement_threshold=3.50 computation_parameters=[Save memory (but be slower)] '
