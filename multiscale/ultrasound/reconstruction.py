...
def clean_position_text(pos_text: dict) -> (np.ndarray, list):
        ...
        if 'POSITIONS' in pos_text:
                ...
                stage_positions = pos_text['map']['StagePositions']['array']
                pos_list = []
                pos_labels = []

                for row in stage_positions:
                        device_positions = row['DevicePositions']['array']
                        xy_position = device_positions[0]['Position_um']['array']
                        pos_list.append([xy_position[0], xy_position[1]])
                        pos_labels.append(row['Label']['scalar'])
